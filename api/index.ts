...
const createApp = (): Express => {
  ...
  const allowedOrigins = [
    process.env.FRONTEND_URL || 'https://personalized-learning-copilot.netlify.net',
...
app.get('/api/status', async (req: Request, res: Response) => {
  ...
  // API Routes
  app.use('/api/chat', authMiddleware, chatRoutes({} as any)); // Mock io for serverless
...
export default async (req: Request, res: Response) => {
  ...
  // Create Express app instance for this request
  const app = createApp();
