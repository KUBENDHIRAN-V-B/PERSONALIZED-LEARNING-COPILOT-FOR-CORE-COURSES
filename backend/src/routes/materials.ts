...
router.get('/:materialId', (req: AuthRequest, res: Response) => {
  try {
    const userId = req.userId || 'demo-user';
...
// Delete material
router.delete('/:materialId', (req: AuthRequest, res: Response) => {
  try {
    const userId = req.userId || 'demo-user';
    const { materialId } = req.params;
...
router.post('/search', (req: AuthRequest, res: Response) => {
  try {
    const userId = req.userId || 'demo-user';
