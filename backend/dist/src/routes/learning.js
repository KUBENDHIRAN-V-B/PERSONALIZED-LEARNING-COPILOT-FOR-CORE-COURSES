...
router.put('/profile', (req, res) => {
    try {
        ...
        if (!profile) {
            ...
            if (preferredPace)
                profile.preferredPace = preferredPace;
        }
...
// Get mastery scores
router.get('/mastery/:courseId', (req, res) => {
    try {
        const userId = req.userId;
...
router.post('/mastery/:courseId/:concept', (req, res) => {
    try {
        const userId = req.userId;
...
// Get learning path
router.get('/path/:courseId', (req, res) => {
    try {
        const { courseId } = req.params;
        const learningPaths = {
            dsa: {
...
function calculateOverallMastery(scores) {
